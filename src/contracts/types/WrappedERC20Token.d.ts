...
interface WrappedERC20TokenInterface extends ethers.utils.Interface {
    functions: {
...
export class WrappedERC20Token extends Contract {
    ...
    interface: WrappedERC20TokenInterface;
